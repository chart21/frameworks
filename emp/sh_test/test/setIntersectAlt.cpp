...
void test_setIntersectAlt(string inputs_a[], string inputs_b[]) {
...
int main(int argc, char** argv) {
    ...
    if (argc == 2 && strcmp(argv[1], "-m") == 0 ) {
        setup_plain_prot(true, "setIntersectAlt.circuit.txt");
        //BITSIZE = 8;
        ...
        test_setIntersectAlt(inputs, inputs);
        finalize_plain_prot();
	return 0;
    }
    ...
    sprintf(fname_a, "data/setIntersectAlt/%d.1.dat", BITSIZE);
    sprintf(fname_b, "data/setIntersectAlt/%d.2.dat", BITSIZE);
    ...
    test_setIntersectAlt(inputs_a, inputs_b);
    delete io;
}
